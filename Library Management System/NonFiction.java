...
/**
 * This class helps reads information about Non fictional books from user as well as from file and prints it
...
public class NonFiction extends Books{
	...
	/**
	 * Takes in input from the keyboard for various properties of the Non fiction class and its subclass
	...
	/**
	 * Takes in input from the file for various properties of the Non fiction class and its subclass
