...
/**
 * This class helps reads information about Fantasy books from user as well as from file and prints it
...
public class Fantasy extends Fiction{
	...
	/**
	 * Takes in input from the keyboard for various properties of the Fantasy class and its subclass
	...
	protected void readBookInfoFromUser(Scanner scan) {
		...
		while(loopingTest==0) {
			...
			try {
					...
					System.out.print("Enter fantasy novel name: ");	//asks user to enter fantasy novel name
					name=scan.next();
	...
	/**
	 * Takes in input from the file for various properties of the Fantasy class and its subclass
